...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('experimenteditor', '0012_auto_20170608_1228'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2017, 6, 8, 17, 28, 54, 591739, tzinfo=utc), unique=True, verbose_name='Experiment Start Date'),
        ),
    ]
